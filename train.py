...
def main(args):
    ...
    rest_param = [p for n, p in model_without_ddp.named_parameters() if p.requires_grad and
                  (n.startswith('cross_modal_encoder') or n.startswith('multi_stage_decoder') or n.startswith('bbox_embed') or n.startswith('bert_proj'))]
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser('SARVG training script', parents=[get_args_parser()])
